...
if __name__ == "__main__":
    ...
    from dirtbear.dflater import ex2df, ex4df, exenv, exoptim
...
from dirtbear.spanner.manidf import merge_dfs
from dirtbear.dflater.ex2df import compress_hierarchy, flat_records
from dirtbear.dflater.ex4df import trans_on_df, agg_on_df
from dirtbear.dflater.exoptim import compile_deps, get_envp, EnvParser
