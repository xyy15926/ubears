...
if __name__ == "__main__":
    ...
    from dirtbear.dflater import ex2df, ex4df, exoptim, callables
...
from dirtbear.dflater.exoptim import EnvParser, get_envp
from dirtbear.spanner.pdsl import (
    save_with_excel, save_with_pickle, load_from_pickle
)
from suitbear.dirt.exdf import (
    flat_ft_dfs, trans_from_dfs,
    agg_from_dfs, dep_from_fconfs
)
from suitbear.pboc.confflat import df_flat_confs
from suitbear.pboc.conftrans import MAPPERS, MAPPERS_CODE, df_trans_confs
from suitbear.pboc.confagg import (
    df_agg_confs,
    LV2_AGG_CONF, LV20_AGG_CONF, LV1_AGG_CONF
)
from suitbear.pboc.confmark import df_mark_confs
from suitbear.pboc.gotcha import mosaic_sensitives
...
if __name__ == "__main__":
    ...
    dfs, trans_ret, agg_ret, mark_ret = pboc_vars(dfs, agg_keys, envp=envp)
    ...
    flats_file = f"pboc/pboc_flats_{agg_keys}.xlsx"
    aggs_file = f"pboc/pboc_aggs_{agg_keys}.xlsx"
    marks_file = f"pboc/pboc_marks_{agg_keys}.xlsx"
