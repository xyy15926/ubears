...
if __name__ == "__main__":
    ...
    from dirtbear.dflater import ex2df, ex4df, callables
...
from suitbear.kgraph.display import draw_rels
...
from suitbear.autofin.conftrans import (
    df_trans_confs, MAPPERS, MAPPERS_CODE
)
